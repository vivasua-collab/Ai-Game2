...
export async function POST(request: NextRequest) {
  try {
    ...
    if (!characterId) {
      console.error("[QiStone] Missing characterId");
    ...
    console.log("[QiStone] Item data created:", {
      name: itemData.name,
    ...
    if (!itemData.name || !itemData.type || !itemData.category || !itemData.rarity) {
      console.error("[QiStone] Missing required fields in itemData:", itemData);
      return NextResponse.json(
    ...
    console.error("[QiStone] Error adding Qi Stone:", {
      message: errorMessage,
      stack: errorStack,
      body: { characterId, quality, quantity },
    });
    
    return NextResponse.json(
      { 
        success: false, 
        error: `Failed to add Qi Stone: ${errorMessage}`,
