...
2. Для обычного повествования: type = "narration", content = описание сцены
3. Для системных сообщений (интерфейс, уведомления): type = "system"
4. При ошибках или невозможных действиях: type = "error"
5. Если действие требует времени, укажи timeAdvance
6. Если меняются характеристики, укажи stateUpdate
...
- Пример хорошего ответа: {"type":"narration","content":"Ты оглядываешься и видишь..."}`;
