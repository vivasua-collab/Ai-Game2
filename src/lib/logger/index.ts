 ...
 *
 * ВАЖНО: Логи сохраняются только в консоль и буфер памяти.
 * Сохранение в БД отключено для упрощения архитектуры.
 *
 * @version 2.0 - обновлено для устранения проблем с БД
 */
...
export async function log(
  ...
  if (level === "ERROR" || level === "WARN") {
    try {
      ...
      // Если не удалось сохранить в БД, выводим в консоль (не блокируем выполнение)
