...
// Type for Location from Prisma
export type CharacterLocationData = Prisma.LocationGetPayload<Record<string, never>>;
...
export class CharacterService {
  ...
  static async getCharacterWithLocation(characterId: string): Promise<{
    ...
    location: CharacterLocationData | null;
    error?: string;
  }> {
    try {
      const character = await db.character.findUnique({
