...
/**
 * Базовый шанс прерывания медитации по типу местности
 */
export const MEDITATION_INTERRUPTION_LOCATION_CHANCE: Record<string, number> = {
  // Безопасные места
  temple: 0.02,        // Храм - почти полная безопасность
  sect_grounds: 0.03,  // Территория секты
  village: 0.05,       // Деревня
  city: 0.05,          // Город
  ...
  // Леса
  forest: 0.15,        // Лес
  bamboo_forest: 0.12, // Бамбуковый лес
  cherry_grove: 0.10,  // Вишнёвая роща
  
  // Горы и холмы
  hills: 0.18,         // Холмы
  mountains: 0.25,     // Горы
  mountain_peak: 0.30, // Горная вершина
  
  // Опасные места
  cave: 0.25,          // Пещера
  swamp: 0.30,         // Болото
  desert: 0.28,        // Пустыня
  wasteland: 0.35,     // Пустошь
  
  // Особые места
  sacred_ground: 0.05, // Священное место
  ruins: 0.20,         // Руины
  battlefield: 0.40,   // Поле битвы
  demon_realm: 0.50,   // Демоническая область
} as const;

/**
 * Модификатор шанса прерывания по времени суток
 */
export const MEDITATION_INTERRUPTION_TIME_MODIFIERS: Record<string, number> = {
  dawn: 0.8,      // Рассвет - спокойно
  morning: 1.0,   // Утро - нормально
  day: 1.2,       // День - больше активности
  evening: 1.0,   // Вечер - нормально
  dusk: 1.1,      // Сумерки - немного опаснее
  night: 1.5,     // Ночь - опаснее всего
} as const;
