...

{
  ...
  "content": "Текст повествования или системного сообщения",
  "stateUpdate": {
    "currentQi": число,
    "fatigue": число
  },
...
ПРАВИЛА ВЫВОДА:
1. Для обычного повествования: type = "narration"
2. Для системных сообщений (интерфейс, уведомления): type = "system"
3. При ошибках или невозможных действиях: type = "error"
4. Если действие требует времени, укажи timeAdvance
5. Если меняются характеристики, укажи stateUpdate`;
