...
import { QI_CONSTANTS, BREAKTHROUGH_CONSTANTS, MEDITATION_CONSTANTS, CULTIVATION_LEVEL_NAMES } from './constants';
import type { Character, Location, BreakthroughRequirements, BreakthroughResult, QiRates } from '@/types/game';
...
export function calculateQiRates(
  ...
  location: Pick<Location, 'qiDensity'> | null
): QiRates {
