...
| TruthSystem.getSessionState is not a function | Singleton - использовать getInstance() | ✅ Исправлено |
...
| 2025-03-01 | **Исправлен TruthSystem.getInstance() - вызов Singleton через getInstance()** |
