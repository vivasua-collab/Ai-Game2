 ...
 * 
 * @updated 2026-03-11 12:00 - Removed sessionStorage, memory-only storage
 */
...
export type { Location, Character, NPC, GameEventType, GameEvent };
