...
export class WorldService {
  ...
  static async generateWorldEvents(
    ...
    try {
      ...
      const events: Prisma.WorldEvent[] = [];
   ...
   */
  static calculateLocationDanger(location: Location | Prisma.Location | null): number {
   ...
   */
  static getLocationInterruptionChance(location: Location | Prisma.Location | null): number {
