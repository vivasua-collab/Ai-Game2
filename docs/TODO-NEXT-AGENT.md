...
| # | Задача | Статус |
|---|--------|--------|
| 1 | Удаление мира в chat API | ⬜ Pending |
| 2 | Атомарный старт игры | ⬜ Pending |
| 3 | Защита API логов | ⬜ Pending |
| 4 | Синхронизация startQi | ⬜ Pending |
| 5 | Prisma query logging | ⬜ Pending |
| 6 | Проход по типам | ⬜ Pending |
| 7 | Выборка сообщений | ⬜ Pending |
