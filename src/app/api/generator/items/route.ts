/**
 * API для работы с расходниками V1 (consumables, qi_stones)
 * 
 * ⚠️ Для экипировки используйте /api/generator/equipment (V2)
 * 
 * Этот API используется только для:
 * - consumables (таблетки, эликсиры, еда)
 * - qi_stones (камни Ци)
 * 
