    ...
    <div className="space-y-6">
      ...
      <div className="bg-amber-900/20 border border-amber-700/50 rounded-lg p-3">
        <div className="flex items-start gap-2">
          ...
          <div>
            <div className="text-sm font-medium text-amber-400">Важно: Расходники НЕ добавляют Ци</div>
            <p className="text-xs text-slate-400 mt-1">
              Для восстановления Ци используйте зарядники с камнями Ци.
              Расходники предназначены для лечения, баффов и других эффектов.
            </p>
          </div>
        </div>
      </div>
