...
export type { TechniqueType, CombatSubtype } from './technique-generator';
...
export type IdPrefix = 
  ...
  // Экипировка (v2 генераторы)
  | 'WP'  // Weapon — оружие
  | 'AR'  // Armor — броня
  | 'CH'  // Charger — зарядник
  | 'AC'  // Accessory — аксессуар
  | 'AF'  // Artifact — артефакт
  // Расходники и материалы
  | 'CS'  // Consumable — расходник
  | 'QS'  // Qi Stone — камень Ци
  // Общие
  | 'IT'  // Item — предмет (общий)
...
export const ID_PREFIX_CONFIG: Record<IdPrefix, IdPrefixConfig> = {
  ...
  WP: {
    ...
    name: 'Оружие',
    nameEn: 'Weapon',
    description: 'Оружие ближнего и дальнего боя',
  },
  AR: {
    prefix: 'AR',
    name: 'Броня',
  ...
  CH: {
    ...
    name: 'Зарядник',
    nameEn: 'Charger',
    description: 'Устройства для усиления техник',
  },
  AC: {
    prefix: 'AC',
    name: 'Аксессуар',
    nameEn: 'Accessory',
    description: 'Кольца, амулеты, браслеты',
  },
  AF: {
    prefix: 'AF',
    name: 'Артефакт',
    nameEn: 'Artifact',
    description: 'Уникальные предметы силы',
  },
  ...
  CS: {
    ...
    name: 'Расходник',
    nameEn: 'Consumable',
    description: 'Таблетки, эликсиры, еда',
  },
  QS: {
    prefix: 'QS',
    name: 'Камень Ци',
    nameEn: 'Qi Stone',
    description: 'Духовные камни',
  },
  ...
  IT: {
    ...
    name: 'Предмет',
    nameEn: 'Item',
    description: 'Предметы экипировки (общий)',
  },
  NP: {
    prefix: 'NP',
    name: 'NPC',
 ...
 * Префикс для оружия
 */
export const WEAPON_PREFIX: IdPrefix = 'WP';

/**
 * Префикс для брони
 */
export const ARMOR_PREFIX: IdPrefix = 'AR';

/**
 * Префикс для зарядников
 */
export const CHARGER_PREFIX: IdPrefix = 'CH';

/**
 * Префикс для аксессуаров
 */
export const ACCESSORY_PREFIX: IdPrefix = 'AC';

/**
 * Префикс для артефактов
 */
export const ARTIFACT_PREFIX: IdPrefix = 'AF';

/**
 * Префикс для расходников
 */
export const CONSUMABLE_PREFIX: IdPrefix = 'CS';

/**
 * Префикс для камней Ци
 */
export const QI_STONE_PREFIX: IdPrefix = 'QS';
