...
|---|--------|-----------|-----------|--------|
| 1 | Унификация типов (game-shared.ts) | 🔴 Высокий | 🟡 Средняя | ⬜ Не начато |
| 2 | Разделение qi-system / qi-shared | 🟡 Средний | 🟢 Низкая | ⬜ Не начато |
| 3 | Zod валидация для всех API | 🔴 Высокий | 🟡 Средняя | ⬜ Не начато |
| 4 | Рефакторинг request-router | 🟡 Средний | 🟡 Средняя | ⬜ Не начато |
